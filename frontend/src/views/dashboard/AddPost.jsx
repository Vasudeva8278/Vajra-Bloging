...
function AddPost() {
    ...
    const handleCreatePost = async (e) => {
        ...
        try {
            const response = await apiInstance.post("author/dashboard/post-create/", jsonData);
            console.log(response.data);
                                ...
                                <form onSubmit={handleCreatePost} className="pb-8 mt-5">
                                    <div className="card mb-3">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <img style={{ width: "100%", height: "330px", objectFit: "cover", borderRadius: "10px" }} className="mb-4" src={post.image || "https://www.eclosio.ong/wp-content/uploads/2018/08/default.png"} alt="" />
                                            <div className="mb-3">
                                                <label htmlFor="postThumbnail" className="form-label">
                                                    Thumbnail URL
                                                </label>
